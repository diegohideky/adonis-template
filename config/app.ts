...
export const apiV1: string = Env.get('PREFIX') + Env.get('V1')

export const tokenExpiration: string = Env.get('TOKEN_EXPIRATION')

export const redisEnabled: boolean = +Env.get('REDIS_ENABLED') === 1
